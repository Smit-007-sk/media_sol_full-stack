...
export default function VitalisHero() {
  ...
  return (
    <section className="relative bg-gradient-to-b from-[#E6FFFA] via-[#F0FDFA] to-white py-16 lg:py-24 text-[#0F172A] overflow-hidden" style={{ fontFamily: 'var(--theme-body-font, inherit)' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* RADICAL CENTERED SEARCH PORTAL HERO */}
        <div className="max-w-4xl mx-auto text-center space-y-8">
          
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#CCFBF1] text-[#0F766E] text-xs font-bold uppercase tracking-wider border border-[#99F6E4] mx-auto" style={{ color: 'var(--theme-primary, #0F766E)' }}>
            <HeartPulse className="w-4 h-4 text-[#0D9488] fill-current animate-pulse" style={{ color: 'var(--theme-primary, #0D9488)' }} />
            <span>24/7 Virtual Telehealth Portal</span>
          </div>

          <h1 className="font-sans text-4xl sm:text-6xl font-extrabold text-[#0F2942] leading-tight tracking-tight" style={{ fontFamily: 'var(--theme-heading-font, inherit)' }}>
            Find Your Specialist &amp; <br />
            <span className="bg-gradient-to-r from-[#0284C7] via-[#0D9488] to-[#059669] bg-clip-text text-transparent" style={{ color: 'var(--theme-primary, inherit)' }}>
              Book Instant Care
            </span>
          </h1>
          ...
          <form onSubmit={handleSearch} className="relative max-w-2xl mx-auto">
            <div className="flex items-center bg-white rounded-full p-2 border-2 border-teal-200 shadow-xl focus-within:border-[#0284C7] transition-all">
              ...
              <button
                type="submit"
                style={{ backgroundColor: 'var(--theme-primary, #0284C7)', color: '#ffffff' }}
                className="bg-[#0284C7] hover:opacity-90 text-white px-6 py-3 rounded-full font-bold text-sm shadow-md transition-all shrink-0 flex items-center gap-1.5"
              >
                <span>Find Care</span>
