...
export default function VerveHero() {
  return (
    <section className="relative bg-[#181717] text-[#EAE5D9] border-b border-[#2D2A28] font-sans" style={{ backgroundColor: 'var(--theme-background, #181717)', color: 'var(--theme-text, #EAE5D9)' }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 min-h-[85vh]">
          ...
          <div className="lg:col-span-6 py-12 lg:py-20 lg:pr-12 border-b lg:border-b-0 lg:border-r border-[#332F2D] flex flex-col justify-between text-left">
            ...
            <div className="space-y-6">
              <div className="font-mono text-xs text-[#D96B43] tracking-[0.3em] uppercase font-bold" style={{ color: 'var(--theme-secondary, #D96B43)' }}>
                STUDIO VERVE // MAGAZINE ISSUE N° 42
              </div>

              <h1 className="font-serif text-6xl sm:text-7xl lg:text-8xl font-normal leading-[0.9] tracking-tight" style={{ fontFamily: 'var(--theme-heading-font, inherit)' }}>
                RAW <br />
                <span className="italic text-[#D96B43] font-light" style={{ color: 'var(--theme-primary, #D96B43)' }}>SCULPTURAL</span> <br />
                MANIFESTO
              </h1>

              <p className="text-base text-[#BDB5A6] font-sans max-w-md leading-relaxed pt-4" style={{ fontFamily: 'var(--theme-body-font, inherit)' }}>
            ...
            <div className="pt-10 flex items-center gap-6">
              <a
                href="#services"
                style={{ backgroundColor: 'var(--theme-primary, #D96B43)', color: '#ffffff' }}
                className="inline-flex items-center gap-3 bg-[#D96B43] text-white px-8 py-4 font-mono text-xs uppercase font-bold tracking-widest hover:opacity-90 transition-all"
              >
          ...
          <div className="lg:col-span-6 py-12 lg:py-20 lg:pl-12 space-y-8 flex flex-col justify-center">
            ...
            <div className="relative h-72 sm:h-96 bg-gradient-to-tr from-[#242120] via-[#3D3734] to-[#1C1A19] border border-[#332F2D] p-8 flex flex-col justify-between group overflow-hidden">
              <span className="font-mono text-xs text-[#D96B43] font-bold" style={{ color: 'var(--theme-secondary, #D96B43)' }}>SPREAD 01 // EXHIBITION</span>
            ...
            <div className="relative h-60 bg-[#252220] border border-[#332F2D] p-8 flex flex-col justify-between group">
              <span className="font-mono text-xs text-[#D96B43] font-bold" style={{ color: 'var(--theme-secondary, #D96B43)' }}>SPREAD 02 // CAMPAIGN</span>
