...
export default function ServicesSection() {
  ...
  // Passive, high-performance scroll listener calculating true document scroll progress
  useEffect(() => {
    let ticking = false;
  ...
  return (
    <section
      id="services"
      ref={containerRef}
      className="services-scroll-wrapper relative w-full"
      style={{ height: "350vh" }}
    >
      {/* Viewport Pinned Sticky Container */}
      <div
        className="services-sticky sticky top-0 w-full h-screen flex flex-col justify-center items-center py-4 px-4 sm:px-6 md:px-12 lg:px-16 overflow-hidden z-20"
      ...
      >
        <div className="w-full max-w-7xl mx-auto flex flex-col justify-center h-full max-h-[92vh]">
          ...
          <div className="flex flex-col items-center text-center mb-4 sm:mb-6 shrink-0">
            ...
            <h2 className="font-sans text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-[#1C1E1B] mb-1.5">
              Solutions that{" "}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center flex-grow overflow-hidden">
                  ...
                  return (
                    <div key={item.id} className="relative flex items-center">
                      ...
                      <button
                        ...
                        className={`w-full text-left p-2.5 sm:p-3 rounded-2xl transition-all duration-300 flex items-center justify-between border ${
                          isActive
            ...
            <div className="lg:col-span-7">
              <div className="bg-[#FAF8F4] border border-[#E5DFD3] rounded-3xl p-5 sm:p-7 shadow-xl relative overflow-hidden">
                  ...
                  >
                    ...
                    <div className="md:col-span-6 flex flex-col justify-between space-y-4">
                      <div>
                        ...
                        <h3 className="font-sans text-lg sm:text-xl font-bold text-[#1C1E1B] leading-snug mb-2">
                          {activeService.title}
                        </h3>
