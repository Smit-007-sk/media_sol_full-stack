...
export default function AetheriaHero() {
  ...
  return (
    <section className="relative bg-[#07080D] text-white py-20 lg:py-28 overflow-hidden font-mono border-b border-purple-900/30" style={{ backgroundColor: 'var(--theme-background, #07080D)', color: 'var(--theme-text, #ffffff)' }}>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 space-y-8">
        ...
        {/* Top Centered Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-purple-950/80 border border-purple-700/50 text-purple-300 text-xs font-bold uppercase tracking-widest mx-auto" style={{ borderColor: 'var(--theme-secondary, rgba(168,85,247,0.5))' }}>
          <Sparkles className="w-4 h-4 text-emerald-400 animate-pulse" style={{ color: 'var(--theme-secondary, #34d399)' }} />
          <span>AETHERIA NEURAL OS // VERSION 4.2</span>
        </div>

        {/* Big Centered Headline */}
        <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold text-white leading-tight tracking-tight max-w-4xl mx-auto" style={{ fontFamily: 'var(--theme-heading-font, inherit)' }}>
          The Autonomous <br />
          <span className="bg-gradient-to-r from-purple-400 via-indigo-300 to-emerald-400 bg-clip-text text-transparent" style={{ color: 'var(--theme-primary, inherit)' }}>
            AI Command Center
          </span>
        </h1>

        <p className="text-base sm:text-lg text-gray-400 font-sans max-w-2xl mx-auto leading-relaxed" style={{ fontFamily: 'var(--theme-body-font, inherit)' }}>
        ...
        <div className="mt-10 bg-[#0D0E17] rounded-3xl border border-purple-500/40 p-4 sm:p-6 shadow-2xl text-left max-w-4xl mx-auto" style={{ borderColor: 'var(--theme-primary, rgba(168,85,247,0.4))' }}>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 pb-4 border-b border-gray-800">
            ...
            <div className="flex items-center gap-1 bg-[#05060A] p-1 rounded-xl border border-gray-800 text-xs">
              <button
                ...
                style={activeTab === "terminal" ? { backgroundColor: 'var(--theme-primary, #9333ea)', color: '#ffffff' } : {}}
              ...
              <button
                ...
                style={activeTab === "api" ? { backgroundColor: 'var(--theme-primary, #9333ea)', color: '#ffffff' } : {}}
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg font-bold transition-all ${
              ...
              <button
                ...
                style={activeTab === "logs" ? { backgroundColor: 'var(--theme-primary, #9333ea)', color: '#ffffff' } : {}}
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg font-bold transition-all ${
            ...
            {activeTab === "terminal" && (
              <div className="space-y-3 font-mono text-xs sm:text-sm">
                <div className="text-gray-400">
                  <span className="text-purple-400 font-bold" style={{ color: 'var(--theme-secondary, #c084fc)' }}>$</span> {prompt}
                </div>
