...
export default function Hero({ onOpenQuote, onOpenDemo }: HeroProps) {
  return (
    <section className="relative pt-6 sm:pt-10 pb-16 lg:pb-24 overflow-hidden hero-glow">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 sm:space-y-8 text-left">
            ...
            <div className="inline-block">
              <span className="text-[10px] sm:text-xs font-bold tracking-[0.25em] text-[#B88E44] uppercase font-sans">
                SMART IDEAS. POWERFUL SOLUTIONS.
              </span>
            </div>

            {/* Main Headline */}
            <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl xl:text-[64px] font-medium leading-[1.1] text-[#1F2421] tracking-tight">
              Build a Modern <br />
              Website for Your <br />
              <span className="font-serif italic font-normal text-[#B88E44] swoosh-underline inline-block pb-1">
                Business
              </span>
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-2.5 sm:gap-3 pt-1">
              <div className="glass-pill px-3.5 py-1.5 rounded-full flex items-center gap-2 text-xs font-semibold text-[#1F2421] shadow-sm hover:scale-105 transition-transform">
                <Monitor className="w-3.5 h-3.5 text-[#0F382C]" />
                <span>Modern Design</span>
              </div>
              <div className="glass-pill px-3.5 py-1.5 rounded-full flex items-center gap-2 text-xs font-semibold text-[#1F2421] shadow-sm hover:scale-105 transition-transform">
                <Zap className="w-3.5 h-3.5 text-[#0F382C]" />
                <span>Fast Performance</span>
              </div>
              <div className="glass-pill px-3.5 py-1.5 rounded-full flex items-center gap-2 text-xs font-semibold text-[#1F2421] shadow-sm hover:scale-105 transition-transform">
                <Smartphone className="w-3.5 h-3.5 text-[#0F382C]" />
            ...
            <div className="flex flex-wrap items-center gap-4 pt-3">
              <button
                onClick={onOpenQuote}
                className="group flex items-center gap-2.5 bg-[#0F382C] text-white px-7 py-3.5 rounded-xl font-medium text-sm sm:text-base hover:bg-[#08291F] shadow-lg shadow-[#0F382C]/15 hover:shadow-xl hover:shadow-[#0F382C]/25 transition-all active:scale-95"
              >
